                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-12">
                            <div class="left_image">
                                <img src="{{ asset('image/'.$courses->image) }}" alt="Image missing" class="img-fluid"/>
                            </div><br>
                            <div>
                                        ...
                                        <div class=" user-media">
                                            <div class="user-wrapper">
                                                <a class="user-link" href="/author/{{ $author[0]->id }}">
                                                    <img class="media-object img-thumbnail user-img rounded-circle " alt="User Picture" src="{{ asset('image/'.$author[0]->user_image) }}">
