                    ...
                    <div class="btn-group">
                        <div class="user-settings no-bg">
                            <button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
                                ...
                                <img src="{{ asset('image/'.Auth::user()->user_image) }}" class="admin_img2 img-thumbnail rounded-circle avatar-img"
                    ...
                    <div class="media user-media">
                        ...
                        <div class="user-wrapper">
                            <a class="user-link" href="/author/{{ Auth::user()->id }}">
                                ...
                                <img class="media-object img-thumbnail user-img rounded-circle admin_img3" alt="User Picture" src="{{ asset('image/'.Auth::user()->user_image) }}" />
