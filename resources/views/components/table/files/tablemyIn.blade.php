                ...
                <tbody>
                    @foreach ($files as $file)
                            <tr>
                                ...
                                <td>{{ $file->mime }}</td>
                                <td>
                                    <a href="/lessons/{{ $file->lesson_id }}"><button class="buttonSpacing widget_btn btn btn-sm btn-outline-primary"><i class="fa fa-angle-double-right" aria-hidden="true"></i> VIEW INDEPENDENT FILE</button></a>
                                    <a href="/file/download/{{ $file->id }}"><button class="buttonSpacing widget_btn btn btn-sm btn-outline-primary"><i class="fa fa-angle-double-right" aria-hidden="true"></i> DOWNLOAD INDEPENDENT FILE</button></a>
                                </td>
                            </tr>
                    @endforeach
                </tbody>
